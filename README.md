...
![AI 客服](pic/AI_chat.jpg)

右下角渐变色悬浮按钮，点击弹出聊天面板。底层接入 DeepSeek API，支持 Function Calling，可实时调用 6 种业务工具（系统概览 / 热门商品 / 个性化推荐 / 库存状态 / 商品详情 / 系统信息），自然语言查询与系统数据实时联动。最多 5 轮工具调用，纯文本回复，Enter 发送 / Escape 关闭。
